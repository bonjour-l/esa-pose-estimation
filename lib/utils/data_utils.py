...
class LineModModelDB(object):
    ...
    def __init__(self):
        ...
        self.sift_pattern = os.path.join(cfg.LINEMOD,'{}/{}.txt')
    ...
    def get_sift_3d(self,class_type):
        ...
        sift_path = self.sift_pattern.format(class_type,class_type)
...
class LineModImageDB(object):
    ...
    '''
    def __init__(self, cls_name, render_num=30000, fuse_num=10000, ms_num=10000,
    ...
    def collect_render_set_info(self,pkl_file,render_dir,format='jpg'):
        ...
        for k in range(self.render_num):
            ...
            data['K']=np.array([[572.4114, 0., 325.2611],
                                [0., 573.57043, 242.04899],
                                [0., 0., 1.]])
            data['cls_typ']=self.cls_name
            data['rnd_typ']='render'
            data['farthest_3d']=modeldb.get_farthest_3d(self.cls_name)
            data['sift_3d']=modeldb.get_sift_3d(self.cls_name)
            data['sift']=projector.project(modeldb.get_sift_3d(self.cls_name),data['RT'],'blender')
    ...
    def collect_real_set_info(self):
        ...
        for k in range(img_num):
            ...
            data['sift']=projector.project(modeldb.get_sift_3d(self.cls_name),data['RT'],'linemod')
    ...
    def collect_fuse_info(self):
        ...
        for k in range(self.fuse_num):
            ...
            data['sift']=projector.project_K(modeldb.get_sift_3d(self.cls_name),data['RT'],K)
    ...
    def collect_ms_info(self):
        ...
        for k in range(self.ms_num):
            ...
            for num in [4,12,16,20]:
                data['farthest{}'.format(num)]=projector.project(model_db.get_farthest_3d(self.cls_name,num),data['RT'],'blender')
