...
class Resnet18_8s(nn.Module):
    def __init__(self, ver_dim,  fcdim=256, s8dim=128, s4dim=64, s2dim=32, raw_dim=32):
...
class Resnet50_8s(nn.Module):
    def __init__(self, ver_dim, seg_dim=0, fcdim=384, s8dim=256, s4dim=128, s2dim=64, raw_dim=64):
