...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet18'],model_dir='./data'))
    return model
...
def resnet34(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet34'],model_dir='./data'))
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet50'],model_dir='./data'))
    return model
...
def resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet101'],model_dir='./data'))
    return model
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet152'],model_dir='./data'))
    return model
